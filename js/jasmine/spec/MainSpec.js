describe("main.js", function () {
  describe("when we sanitize user input", () => {
    ...
    // it("should allow supported JIRA key format per documentation for underscores", () => {
    //   expect(sanitizeTicket("PRODUCT_2013-2024")).toEqual("PRODUCT_2013-2024");
    //   expect(sanitizeTicket("MY_EXAMPLE_PROJECT-182")).toEqual("MY_EXAMPLE_PROJECT-182");
    // });

    it("should allow supported JIRA key format per documentation for numbers", () => {
      expect(sanitizeTicket("R2D2-33")).toEqual("R2D2-33");
    });
    ...
    it("should accept links and filter for the ticket ID", () => {
      ...
      expect(sanitizeTicket("http://qunitjs.com/intro/core2D2-123")).toEqual(
        "CORE2D2-123"
      );
    });

    it("should support user use case", () => {
      expect(sanitizeTicket("K4OPS-22")).toEqual("K4OPS-22");
    })
